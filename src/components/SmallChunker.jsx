    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '8px 0 24px', overflow: 'hidden', minHeight: 0 }}>
      ...
      {step && !loading && !cascadeLoading && (
        <div style={{ padding: '4px 24px 8px', display: 'flex', justifyContent: 'space-around', alignItems: 'center' }}>
          ...
          >
            <div style={{ width: 40, height: 40, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,192,72,0.07)', border: `1px solid rgba(255,192,72,0.22)` }}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={T.amber} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            <div style={{ width: 40, height: 40, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,192,72,0.07)', border: `1px solid rgba(255,192,72,0.22)` }}>
              <svg width="16" height="16" viewBox="0 0 10 10" fill="none" stroke={T.amber} strokeWidth="1" strokeLinecap="round" strokeLinejoin="round">
          ...
          >
            <div style={{ width: 40, height: 40, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,192,72,0.07)', border: `1px solid rgba(255,192,72,0.22)` }}>
              <svg width="16" height="16" viewBox="0 0 14 14" fill={T.amber}>
          ...
          >
            <div style={{ width: 40, height: 40, borderRadius: 12, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(255,192,72,0.07)', border: `1px solid rgba(255,192,72,0.22)` }}>
              <svg width="16" height="16" viewBox="0 0 12 12" fill="none" stroke={T.amber} strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" style={{ animation: regenLoading ? 'spin360 800ms linear infinite' : 'none' }}>
