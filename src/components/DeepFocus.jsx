...
export function DeepFocus({
  ...
  const [loggedCards, setLoggedCards] = useState(() => new Set());
    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '8px 0 24px', overflow: 'hidden', minHeight: 0 }}>
      ...
      <div style={{ padding: '20px 24px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 12 }}>
          ...
          >
            <svg width="10" height="10" viewBox="0 0 14 14" fill={T.purple}>
              <path d="M2 2.4v9.2a.6.6 0 0 0 .92.5l7.3-4.6a.6.6 0 0 0 0-1L2.92 1.9A.6.6 0 0 0 2 2.4z"/>
            </svg>
            <span style={{ fontFamily: T.mono, fontSize: 9, letterSpacing: '0.16em', color: '#fff', fontWeight: 700, textTransform: 'uppercase' }}>Body Double</span>
          </button>
        </div>
      ...
      <div style={{
          ...
          {cascadeLoading ? (
            ...
            <div style={{
              ...
              <p style={{
                ...
                {(batchNumber || 1) === 1
                  ? `Tailoring 4 steps to "${(mission || '').slice(0, 36)}${(mission || '').length > 36 ? '…' : ''}"`
        ...
        {step && !loading && !cascadeLoading && (
          <>
            ...
            {menuOpen && (
              <div style={{
                ...
                {[
                  ...
                  { label: 'Body Double', disabled: false, onClick: () => { setWorkWithMeOpen(true); setMenuOpen(false); }, icon: <path d="M2 2.4v9.2a.6.6 0 0 0 .92.5l7.3-4.6a.6.6 0 0 0 0-1L2.92 1.9A.6.6 0 0 0 2 2.4z"/>, vb: '0 0 14 14', fill: true },
                  ...
                  <button key={label} onClick={onClick} disabled={disabled} style={{
                    ...
                    borderBottom: `1px solid rgba(168,118,255,0.08)`,
                    WebkitTapHighlightColor: 'transparent',
                  }}>
                    <svg width="14" height="14" viewBox={vb} fill={fill ? T.purple : 'none'} stroke={fill ? 'none' : T.purple} strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
                      {icon}{icon2}
                    </svg>
            ...
            >
              <svg width="3" height="13" viewBox="0 0 3 13" fill={T.purple}>
      ...
      <div style={{ padding: '0 24px', display: 'flex', flexDirection: 'column', gap: 10 }}>
        ...
        <div style={{
          ...
          {loading || !step
            ? 'Claude is building your focus path'
            : isFinalInBatch
